...
type ExtrasRecentActivityListOK struct {
	Payload *ExtrasRecentActivityListOKBody
}
...
func (o *ExtrasRecentActivityListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(ExtrasRecentActivityListOKBody)
...
type ExtrasRecentActivityListOKBody struct {
	...
	// results
	// Required: true
	Results []*models.UserAction `json:"results"`
}

// Validate validates this extras recent activity list o k body
func (o *ExtrasRecentActivityListOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *ExtrasRecentActivityListOKBody) validateCount(formats strfmt.Registry) error {

	if err := validate.Required("extrasRecentActivityListOK"+"."+"count", "body", o.Count); err != nil {
		return err
	}
...
func (o *ExtrasRecentActivityListOKBody) validateNext(formats strfmt.Registry) error {

	if swag.IsZero(o.Next) { // not required
		return nil
	}

	if err := validate.FormatOf("extrasRecentActivityListOK"+"."+"next", "body", "uri", o.Next.String(), formats); err != nil {
		return err
	}
...
func (o *ExtrasRecentActivityListOKBody) validatePrevious(formats strfmt.Registry) error {

	if swag.IsZero(o.Previous) { // not required
		return nil
	}

	if err := validate.FormatOf("extrasRecentActivityListOK"+"."+"previous", "body", "uri", o.Previous.String(), formats); err != nil {
		return err
	}
...
func (o *ExtrasRecentActivityListOKBody) validateResults(formats strfmt.Registry) error {

	if err := validate.Required("extrasRecentActivityListOK"+"."+"results", "body", o.Results); err != nil {
		return err
	}
		...
		if o.Results[i] != nil {
			if err := o.Results[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("extrasRecentActivityListOK" + "." + "results" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (o *ExtrasRecentActivityListOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *ExtrasRecentActivityListOKBody) UnmarshalBinary(b []byte) error {
